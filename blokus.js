...
UI.prototype.isBoard = function(x, y) {
  return x < board.WIDTH * BOARD_SCALE && y < board.HEIGHT * BOARD_SCALE;
}

UI.prototype.getBoardCoor = function(x, y) {
...
UI.prototype.isTiles = function(x, y) {
  return x > 650;
}
...
UI.prototype.drawTiles = function(ctx, x, y, color, player) {
  ctx.fillStyle = color;
  var x_off = x;
  var y_off = y;
...
UI.prototype.useTile = function(tile, color) {
...
Blokus.prototype.draw = function() {
  // Clear the canvas.
  ...
  if (this.holdingPiece != null) {
    ...
    if (this.ui.isBoard(this.mouseX, this.mouseY)) {
      newBoardCoor = this.ui.getBoardCoor(this.mouseX, this.mouseY);
...
Blokus.prototype.play = function() {
  var blokus = this;
...
Blokus.prototype.getNextServerMove = function() {
  var blokus = this;
